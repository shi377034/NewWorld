...
namespace NodeCanvas.Tasks.Actions{
	...
	[Category("Vp_Input")]
	public class GetAxisRaw : ActionTask{
        ...
        void Do()
        {
            ...
            var x = string.IsNullOrEmpty(xAxisName.value) ? 0 : vp_Input.GetAxisRaw(xAxisName.value);
            var y = string.IsNullOrEmpty(yAxisName.value) ? 0 : vp_Input.GetAxisRaw(yAxisName.value);
            var z = string.IsNullOrEmpty(zAxisName.value) ? 0 : vp_Input.GetAxisRaw(zAxisName.value);
