...
public class vp_Input : MonoBehaviour
{
	...
	// paths
	public static string FolderPath = "Resources/Input";
	public static string PrefabPath = "Assets/Resources/Input/vp_Input.prefab";
	...
	public virtual void SetupDefaults( string type = "" )
	{
		...
		if(type == "" || type == "Buttons")
		{
			if (ButtonKeys.Count == 0)
			{
                ...
                AddButton("Roll", KeyCode.Q);
                AddButton("Sprint", KeyCode.LeftShift);
                AddButton("Strafe", KeyCode.Tab);
                ...
                AddSecondaryButton("Roll", KeyCode.None);
                AddSecondaryButton("Sprint", KeyCode.None);
                AddSecondaryButton("Strafe", KeyCode.None);
			}
		}
		...
		if(type == "" || type == "UnityAxis")
		{
			if(UnityAxis.Count == 0)
			{
                ...
                AddUnityAxis("Mouse ScrollWheel");
			}
		}
