...
namespace Devdog.InventoryPro.Editors
{
    ...
    public class InventoryMainEditor : DevdogEditors.BetterEditorWindow
    {
        ...
        public static List<DevdogEditors.IEditorCrud> editors = new List<DevdogEditors.IEditorCrud>(8);
...
//        private string[] _databasesInProject;
        ...
        protected virtual void DrawToolbar()
        {
            ...
            if (GUILayout.Button("< DB", EditorStyles.toolbarStyle, GUILayout.Width(60)))
            {
                ...
                {
                    // Create a database
                    var db = DevdogEditors.ScriptableObjectUtility.CreateAssetChooseSaveFolder<ItemDatabase>("ItemDatabase.asset", true);
                    if (db != null)
                    {
