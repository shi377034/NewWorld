...
namespace Devdog.InventoryPro.Editors.GameRules
{
    public class DeprecatedItemDatabase : GameRuleBase
    {
            ...
            where T2 : ScriptableObject
        {
            ...
            {
                var scriptableObject = DevdogEditors.ScriptableObjectUtility.CreateAsset<T2>(InventoryScriptableObjectUtility.GetSaveFolderForType(typeof (T2)), DateTime.Now.ToFileTimeUtc() + ".asset", false);
