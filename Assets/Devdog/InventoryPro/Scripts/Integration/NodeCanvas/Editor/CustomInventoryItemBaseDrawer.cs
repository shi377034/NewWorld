...
namespace Devdog.InventoryPro.Integration.NodeCanvas
{
    public class CustomInventoryItemBaseDrawer : ObjectDrawer<InventoryItemBase>
    {
        ...
        public override InventoryItemBase OnGUI(GUIContent content, InventoryItemBase instance)
        {
            ...
            ObjectPickerUtility.RenderObjectPickerForType<InventoryItemBase>(rect, content.text, instance, (val) =>
            {
                _pickedValue = val;
            });
