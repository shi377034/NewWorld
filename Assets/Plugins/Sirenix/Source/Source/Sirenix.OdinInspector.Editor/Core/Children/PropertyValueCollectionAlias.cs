...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public sealed class PropertyValueCollectionAlias<TActualValue, TValue> : PropertyValueCollection, IPropertyValueCollection<TValue> where TValue : TActualValue
    {
        ...
        public PropertyValueCollectionAlias(InspectorProperty property, IPropertyValueCollection<TActualValue> aliasedCollection)
            : base(property)
        {
            if (aliasedCollection == null)
            {
                throw new ArgumentException("aliasedCollection");
            }
