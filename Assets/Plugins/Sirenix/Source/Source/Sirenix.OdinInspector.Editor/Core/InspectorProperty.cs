...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public sealed class InspectorProperty
    {
        ...
        internal void ForceUpdatePropertyNameAndPath(int? newIndex)
        {
            ...
            if (this.ValueEntry != null)
            {
                ...
                if (this.ValueEntry.ValueCategory == PropertyValueCategory.DictionaryElement)
                {
                    ...
                    this.Name = InspectorSerializationUtility.GetDictionaryKeyString(key);
        ...
        private void UpdateChildren()
        {
            ...
            else if (this.ValueEntry.ValueIsDictionary)
            {
                if (this.Children == null || this.Children.GetType().IsGenericType == false || this.Children.GetType().GetGenericTypeDefinition() != typeof(DictionaryPropertyChildren<,,>))
                {
        ...
        internal static InspectorProperty Create(PropertyTree tree, InspectorProperty parent, InspectorPropertyInfo info, int index)
        {
            ...
            if (info != null)
            {
                ...
                property.NiceName = ObjectNames.NicifyVariableName(property.Name);
