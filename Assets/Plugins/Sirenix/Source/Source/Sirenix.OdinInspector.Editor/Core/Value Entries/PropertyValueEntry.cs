...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public abstract class PropertyValueEntry : IPropertyValueEntry
    {
        ...
        /// </summary>
        public bool ValueIsDictionary { get; private set; }
        ...
        public void Update()
        {
            ...
            if (!this.BaseValueType.IsValueType)
            {
                ...
                if (this.actualTypeOfValue != type)
                {
                    ...
                    this.ValueIsWeakList = typeof(IList).IsAssignableFrom(type);
                    this.ValueIsStrongList = type.ImplementsOpenGenericInterface(typeof(IList<>));
                    this.ValueIsDictionary = type.ImplementsOpenGenericInterface(typeof(IDictionary<,>));
        ...
        public static PropertyValueEntry Create(InspectorProperty property, Type valueType)
        {
            ...
            result.ValueIsDictionary = valueType.ImplementsOpenGenericInterface(typeof(IDictionary<,>));
            result.ValueIsStrongList = valueType.ImplementsOpenGenericInterface(typeof(IList<>));
            result.ValueIsWeakList = typeof(IList).IsAssignableFrom(valueType);
            result.IsBoxedValueType = result.BaseValueType == typeof(object) && result.TypeOfValue.IsValueType;

            if (parentValueProperty != null)
            {
                result.SerializationBackend = parentValueProperty.BaseValueEntry.SerializationBackend;
    ...
    public abstract class PropertyValueEntry<TValue> : PropertyValueEntry, IPropertyValueEntry<TValue>, IValueEntryActualValueSetter<TValue>
    {
        ...
        /// </summary>
        protected static readonly bool BaseValueIsWeakList = typeof(IList).IsAssignableFrom(typeof(TValue));
        ...
        /// <summary>
        /// Whether <see cref="TValue"/> is derived from <see cref="UnityEngine.Object"/>.
        /// </summary>
        protected static readonly bool ValueIsUnityObject = typeof(UnityEngine.Object).IsAssignableFrom(typeof(TValue));
        ...
        public TValue SmartValue
        {
            ...
            set
            {
                if (ValueIsPrimitive || ValueIsValueType)
                {
        ...
        protected override void Initialize()
        {
            ...
            this.values = new PropertyValueCollection<TValue>(this.Property, this.InternalValuesArray, this.OriginalValuesArray);
        }
    ...
    public abstract class PropertyValueEntry<TParent, TValue> : PropertyValueEntry<TValue>
    {
        ...
        protected override void Initialize()
        {
            ...
            else if (this.ValueIsDictionary)
            {
        ...
        protected sealed override PropertyValueState GetValueState()
        {
            ...
            if (!ValueIsValueType && !ValueIsPrimitive)
            {
                TValue value = values[0];
                string referencePath;

                if (object.ReferenceEquals(value, null) || (ValueIsUnityObject && (((UnityEngine.Object)(object)value) == null /*|| ((UnityEngine.Object)(object)value).SafeIsUnityNull()*/)))
                {
                    for (int i = 1; i < values.Length; i++)
                    {
                        if (!object.ReferenceEquals(values[i], null) || (ValueIsUnityObject && (((UnityEngine.Object)(object)values[i]) == null /*|| ((UnityEngine.Object)(object)values[i]).SafeIsUnityNull()*/)))
                        {
                ...
                else if (this.Property.Tree.ObjectIsReferenced(value, out referencePath) && referencePath != this.Property.Path)
                {
        ...
        public sealed override bool ApplyChanges()
        {
            ...
            if (this.Values.AreDirty)
            {
                ...
                for (int i = 0; i < this.ValueCount; i++)
                {
                    ...
                    if (!EqualityComparer(this.OriginalValuesArray[i], value))
                    {
                        if (this.IsBoxedValueType)
                        {
