...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public static class UnityPropertyEmitter
    {
        ...
        /// <summary>
        /// A handle for an emitted Unity object. When disposed (or collected by the GC) this handle will queue the emitted object instance for destruction.
        /// </summary>
        ...
        /// <summary>
        /// Destroys all emitted objects marked for destruction.
        /// </summary>
        ...
        public static SerializedProperty CreateEmittedScriptableObjectProperty(string fieldName, Type valueType, int targetCount)
        {
            ...
            if (!ScriptableObjectTypeCache.TryGetInnerValue(fieldName, valueType, out resultType))
            {
