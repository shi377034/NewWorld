...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class DrawerInfo
    {
        ...
        /// Not yet documented.
        /// </summary>
        public DrawerInfo(Type drawerType, Type drawnValueType, Type drawnAttributeType, OdinDrawerAttribute attribute)
        {
            this.DrawerType = drawerType;
            this.DrawnValueType = drawnValueType;
            this.DrawnAttributeType = drawnAttributeType;
            this.OdinDrawerAttribute = attribute;
            ...
            if (drawerType.IsGenericType)
            {
                ...
                if (drawerType.GetGenericTypeDefinition() == typeof(UnityPropertyDrawer<,>) || drawerType.GetGenericTypeDefinition() == typeof(UnityDecoratorAttributeDrawer<,>) || drawerType.GetGenericTypeDefinition() == typeof(UnityPropertyAttributeDrawer<,>))
                {
