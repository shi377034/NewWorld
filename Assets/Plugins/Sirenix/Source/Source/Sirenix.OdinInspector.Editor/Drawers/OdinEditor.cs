...
namespace Sirenix.OdinInspector.Editor
{
    ...
    [InitializeOnLoad]
    public abstract class OdinEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Following code commented out for reason - this behaviour has been causing bugs in other editors that spawn new editor instances every frame and draw them
            // See issue 72 https://bitbucket.org/sirenix/odin-inspector/issues/72/argument-exceptions-in-many-of-our
            // It seems to cause no issues to remove it

            //if (Event.current.type == EventType.Layout)
            //{
            //    this.hasSeenLayout = true;
            //}
            //else if (this.hasSeenLayout == false)
            //{
            //    //return;
            //}
