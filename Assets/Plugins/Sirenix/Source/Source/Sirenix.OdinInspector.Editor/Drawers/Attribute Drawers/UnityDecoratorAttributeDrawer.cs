...
namespace Sirenix.OdinInspector.Editor.Drawers
{
    ...
    public sealed class UnityDecoratorAttributeDrawer<TDrawer, TAttribute> : OdinAttributeDrawer<TAttribute> where TDrawer : UnityEditor.DecoratorDrawer, new() where TAttribute : PropertyAttribute
    {
        ...
        static UnityDecoratorAttributeDrawer()
        {
            ...
            {
                Debug.LogError("Could not find the internal Unity field 'DecoratorDrawer.m_Attribute'; UnityDecoratorDrawer alias '" + typeof(UnityDecoratorAttributeDrawer<TDrawer, TAttribute>).GetNiceName() + "' has been disabled.");
            }
            else
            {
        ...
        protected override void DrawPropertyLayout(InspectorProperty property, TAttribute attribute, GUIContent label)
        {
            ...
            {
                SirenixEditorGUI.ErrorMessageBox("Could not find the internal Unity field 'DecoratorDrawer.m_Attribute'; UnityDecoratorDrawer alias '" + typeof(UnityDecoratorAttributeDrawer<TDrawer, TAttribute>).GetNiceName() + "' has been disabled.");
                return;
            }
