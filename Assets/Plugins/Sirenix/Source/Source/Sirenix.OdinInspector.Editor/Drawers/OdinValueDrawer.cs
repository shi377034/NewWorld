...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public abstract class OdinValueDrawer<T> : OdinDrawer
    {
        ...
        /// <exception cref="System.ArgumentException">The given property to draw at path '" + property.Path + "' does not have a value of required type " + typeof(IPropertyValueEntry<T>).GetNiceName() + ".</exception>
