...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public abstract class OdinDrawer
    {
        ...
        /// This is useful if you want some GUI to be enabled regardless of weather a property is read-only or not.
        ...
        /// <summary>
        /// <para>Override this method in order to define custom type constraints to specify weather or not a type should be drawn the drawer.</para>
        /// <para>Note that Odin's <see cref="DrawerLocator" /> have full support for generic class constraints, so most often you can get away without overriding CanDrawTypeFilter.</para>
        /// </summary>
