...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public abstract class OdinAttributeDrawer<TAttribute> : OdinDrawer where TAttribute : Attribute
    {
        ...
        /// </summary>
        protected static readonly bool AllowsMultipleAttributes;
        ...
        protected sealed override void DrawPropertyImplementation(InspectorProperty property, GUIContent label)
        {
            ...
            {
                HashSet<TAttribute> seenAttributes = (HashSet<TAttribute>)property.Context.GetTemporary<HashSet<TAttribute>>(this, SeenAttributesKey);

                attribute = property.Info.GetAttribute(seenAttributes);
