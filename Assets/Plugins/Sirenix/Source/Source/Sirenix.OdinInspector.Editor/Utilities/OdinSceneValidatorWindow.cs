...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class OdinSceneValidatorWindow : EditorWindow
    {
        ...
        /// Opens the window.
        /// </summary>
        [MenuItem("Window/Odin Inspector/Scene Validator", priority = -15)]
        ...
        private void FullScan()
        {
            ...
            this.behaviourValidationInfos = GameObject.FindObjectsOfType<Transform>()
                .Where(x => (x.gameObject.hideFlags & HideFlags.HideInHierarchy) == 0)
