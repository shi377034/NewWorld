...
#pragma warning restore 0618
        ...
        /// </summary>
        public static TypeDrawerPair[] GetEditorsForCompilation()
        {
        ...
        {
            var searchLabel = entry.Property.Context.Get(this, "searchLabel", (GUIContent)null);
            var searchText = entry.Property.Context.Get(this, "searchText", "");
            var displayType = entry.Property.Context.Get(this, "displayType", DisplayType.AllUnityObjects);
            var scrollPos = entry.Property.Context.Get(this, "scrollPos", Vector2.zero);
            ...
            if (GUILayout.Button("Recompile Editors"))
            {
                ...
                EditorApplication.delayCall += () => EditorCompilation.CompileEditors(GetEditorsForCompilation());
            }
            GUILayout.EndHorizontal();
            GUILayout.Space(10);

            SirenixEditorGUI.BeginHorizontalToolbar();
            GUILayout.Label("Generate Editors for", GUILayoutOptions.ExpandWidth(false));
            GUILayout.FlexibleSpace();
            SirenixEditorGUI.VerticalLineSeperator();
        ...
        private void DrawRootTypeGroup(InspectorDefaultEditors editorCategory, IPropertyValueEntry<InspectorTypeDrawingConfig> entry, string searchText)
        {
            ...
            else
            {
                ...
                if (SirenixEditorGUI.BeginFadeGroup(typeGroup, typeGroup.IsExpanded || !searchText.IsNullOrWhitespace(), GeneralDrawerConfig.Instance.GUIFoldoutAnimationDuration))
                {
        ...
        private void DrawType(TypeGroup.TypePair typeToDraw, IPropertyValueEntry<InspectorTypeDrawingConfig> entry)
        {
            ...
            SirenixEditorGUI.BeginListItem();
            {
                ...
                if (typeToDraw.PreExistingEditorType != null)
                {
                    ...
                    GUILayout.Label("Type is already being drawn by the editor '" + typeToDraw.PreExistingEditorType + "'", SirenixGUIStyles.RightAlignedGreyMiniLabel);
