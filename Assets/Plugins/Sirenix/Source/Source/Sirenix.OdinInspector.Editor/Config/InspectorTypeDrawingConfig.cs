    ...
    public sealed class InspectorTypeDrawingConfig
    {
        ...
        private static Type OdinEditorType
        {
            get
            {
                ...
                {
                    odinEditorType = AssemblyUtilities.GetType("Sirenix.OdinInspector.Editor.OdinEditor");
                }
        ...
        public void UpdateCaches()
        {
            ...
            for (int i = 0; i < this.configs.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (drawerType == null)
                    {
                        drawerType = typeof(MissingDrawer);
                    }
                }
        ...
        public static bool UnityInspectorEditorIsValidBase(Type editorType, Type drawnType)
        {
            ...
            if (editorType.IsSealed || !editorType.IsAbstract || !typeof(Editor).IsAssignableFrom(editorType) || editorType.FullName.StartsWith("UnityEditor", StringComparison.InvariantCulture))
            {
                return false;
            }
        ...
        private static class MissingDrawer
        {
        }
    }
}
