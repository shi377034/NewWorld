...
namespace Sirenix.Utilities.Editor
{
    ...
    public class DragHandle
    {
        ...
        internal bool IsBeeingClaimed { get; private set; }
                    ...
                    if (this.IsHovering)
                    {
                        ...
                        if (this.isMouseDown && Event.current.type == EventType.MouseDrag)
                        {
                            ...
                            if (this.Object != null)
                            {
                                ...
                                DragAndDrop.StartDrag("Custom Drag Test");
                            }
                        }
                    }
                }
        ...
        private void FinalizeDropObject()
        {
            if (this.WillDrop)
            {
                ...
                {
                    this.OnDragFinnished(dropEvent);
                }
            }
        }
        ...
        internal object DropObject(DropEvents dropEvent)
        {
            ...
            this.WillDrop = true;
            this.IsBeeingClaimed = dropEvent != DropEvents.None && dropEvent != DropEvents.Canceled;
