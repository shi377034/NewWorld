    ...
    public class GUITabGroup
    {
        ...
        public GUITabPage RegisterTab(string title)
        {
            ...
            if (this.pages.TryGetValue(title, out result) == false)
            {
                ...
                {
                    throw new Exception("Tabs must be registered in Layout first.");
                }
            }
            return result;
        }
        ...
        public void BeginGroup(bool drawToolbar = true, GUIStyle style = null)
        {
            ...
            if (this.currentPage != null && this.pages.ContainsKey(this.currentPage.Title) == false)
            {
            ...
            if (this.drawToolbar)
            {
                ...
                this.DrawToolbar();
                //GUILayout.Space(6);
                //GUILayout.Space(this.toolbarHeight);
            }
        ...
        private void DrawToolbar()
        {
            ...
            SirenixEditorGUI.BeginHorizontalToolbar(ToolbarStyle, 18);
