...
namespace Sirenix.Utilities.Editor
{
    ...
    internal class InstanceCreatorWindow : EditorWindow
    {
        ...
        private static bool CanCreateInstance(Type baseType, Type type)
        {
            ...
            if (type.IsAbstract || type.IsInterface || type.IsGenericTypeDefinition || (!type.IsPrimitive && !type.IsEnum && type != typeof(string) && type.GetConstructor(Type.EmptyTypes) == null))
            {
                return false;
            }
                ...
                rootNode = typeTrees[type] = new TypeTreeNode()
                {
                    ...
                    .Select(a => new TypeTreeNode()
                    {
                        ...
                        ChildNodes = AssemblyUtilities
                            ...
                            .Prepend(additionalTypes.Where(x => x.flag == a.Key).Select(x => x.type))
        ...
        private class TypeTreeNode
        {
            ...
            public void UpdateSearchTerm()
            {
                ...
                if (this.isTypeNode && this.searchString != null)
                {
                    ...
                    {
                        this.SetMatchesSearchTermRecurseive(true);
                    }
                }
            }

            private void SetMatchesSearchTermRecurseive(bool value)
            {
                this.matchesSearchTerm = value;
                if (this.ParentNode != null)
                {
                    this.ParentNode.SetMatchesSearchTermRecurseive(value);
                }
            }
        }
    }
    ...
    public static class InstanceCreator
    {
        ...
        public static void Show(Type type, int controlId, Rect buttonRect = default(Rect))
        {
            ...
            if (buttonRect.width > 0 && buttonRect.height > 0)
            {
                ...
                var windowSize = new Vector2(buttonRect.width, Mathf.Min(buttonRect.width, 400));
            ...
            else
            {
                ...
                window.position = new Rect(windowRect.center - windowSize * 0.5f, windowSize);
            }
        }
    }
}
