...
namespace Sirenix.Serialization
{
    ...
    public static class SerializationPolicies
    {
        ...
        /// <summary>
        /// All fields not marked with <see cref="NonSerializedAttribute"/> are serialized.
        /// </summary>
            ...
            get
            {
                if (everythingPolicy == null)
                {
                    lock (LOCK)
                    {
                        if (everythingPolicy == null)
                        {
                            everythingPolicy = new CustomSerializationPolicy("Sirenix.SerializationPolicies.Everything", true, (member) => member is FieldInfo && member.IsDefined<NonSerializedAttribute>(true) == false);
                        }
                    }
                }
