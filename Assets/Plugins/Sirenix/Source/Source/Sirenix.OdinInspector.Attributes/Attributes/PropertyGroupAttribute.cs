...
namespace Sirenix.OdinInspector
{
    ...
    public abstract class PropertyGroupAttribute : ShowInInspectorAttribute
    {
        ...
        /// <summary>
        /// Combines this attribute with another attribute of the same type. This method invokes the virtual <see cref="CombineValuesWith(PropertyGroupAttribute)"/> method to invoke custom combine logic.
        /// </summary>
