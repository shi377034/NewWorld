...
namespace Sirenix.Serialization
{
    ...
    [SirenixGlobalConfig("Odin Inspector/Serialization")]
    [HideMonoScript]
...
#pragma warning restore 0414
        ...
        /// </summary>
        [DetailedInfoBox("Click to show warning message.", ODIN_SERIALIZATION_CAUTIONARY_WARNING_TEXT, InfoMessageType.Warning)]
        public bool HideSerializationCautionaryMessage = false;

        [SerializeField, Header("Data formatting options"), Indent, ValueDropdown("BuildFormats")]
        ...
        [SerializeField, Header("Logging and error handling"), Indent]
        private LoggingPolicy loggingPolicy = LoggingPolicy.LogErrors;

        [SerializeField, Indent, OnInspectorGUI("OnInspectorGUI", append: true)]
