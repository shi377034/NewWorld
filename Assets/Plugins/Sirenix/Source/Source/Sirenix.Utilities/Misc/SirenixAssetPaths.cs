    ...
    public static class SirenixAssetPaths
    {
        ...
        static SirenixAssetPaths()
        {
            ...
            if (script == null)
            {
                ...
                {
                    Debug.LogError("Could not find folder pattern, 'Sirenix/Assets' anywhere in the project. Defaulting to path '" + DefaultSirenixPluginPath + "'. Something will probably break.");
                }
            }
            else
            {
        ...
        private static string FindFolderPattern()
        {
            ...
            var assetDir = unityDir
                ...
                .FirstOrDefault(x => x.Name == "Assets" && x.Parent.Name == "Sirenix");
