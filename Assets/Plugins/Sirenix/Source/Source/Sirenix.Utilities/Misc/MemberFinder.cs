        ...
        public bool TryGetMembers(out MemberInfo[] memberInfos, out string errorMessage)
        {
            try
            {
                ...
                else
                {
                    ...
                    string strAccessModifies = (isPublic != isNonPublic ? (isPublic ? "public " : "non-public ") : string.Empty) +
                    ...
                    if (this.name == null)
                    {
                        errorMessage = "No " + strAccessModifies + strMemberTypes + strReturnType + "was found in " + this.type.GetNiceName() + ".";
                        return false;
                    }
                    else
                    {
                        errorMessage = "No " + strAccessModifies + strMemberTypes + "named " + this.name + " " + strReturnType + "was found in " + this.type.GetNiceName() + ".";
                        return false;
                    }
                }
            }
