...
{    
    ...
    {        
	    ...
	    GUILayout.Label("Basic Locomotion Version: 2.1a", EditorStyles.boldLabel);
        GUILayout.FlexibleSpace();
        ...
        GUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
	    GUILayout.Label("Melee Combat Version: 2.1a", EditorStyles.boldLabel);
        GUILayout.FlexibleSpace();
        ...
        GUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
        GUILayout.Label("Shooter Version: 1.0", EditorStyles.boldLabel);
        GUILayout.FlexibleSpace();
